 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoCalculatorEFactory_QueryInterface(IEcoComponentFactoryPtr_t me, const UGUID* riid, voidptr_t* ppv) {
 ...
 *
 */
static uint32_t ECOCALLMETHOD CEcoCalculatorEFactory_AddRef(/* in */ IEcoComponentFactoryPtr_t me) {
 ...
 *
 */
static uint32_t ECOCALLMETHOD CEcoCalculatorEFactory_Release(/* in */ IEcoComponentFactoryPtr_t me) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoCalculatorEFactory_Init(/* in */ IEcoComponentFactoryPtr_t me, /* in */ struct IEcoUnknown *pIUnkSystem, /* in */ void* pv) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoCalculatorEFactory_Alloc(/* in */ IEcoComponentFactoryPtr_t me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
    IEcoUnknown* pIUnk = 0;
    int16_t result = ERR_ECO_POINTER;
 ...
 *
 */
static char_t* ECOCALLMETHOD CEcoCalculatorEFactory_get_Name(/* in */ IEcoComponentFactoryPtr_t me) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
 ...
 *
 */
static char_t* ECOCALLMETHOD CEcoCalculatorEFactory_get_Version(/* in */ IEcoComponentFactoryPtr_t me) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
 ...
 *
 */
static char_t* ECOCALLMETHOD CEcoCalculatorEFactory_get_Manufacturer(/* in */ IEcoComponentFactoryPtr_t me) {
    CEcoCalculatorEFactory* pCMe = (CEcoCalculatorEFactory*)me;
